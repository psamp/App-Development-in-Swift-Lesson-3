 ...
 */
let phoneCapacityMB = 8000;
let phoneStorageInUseMB = 3000;
let phoneRemainingStorageMB = phoneCapacityMB - phoneStorageInUseMB;

let oneMinuteOfVideoMB = 150;
let videoMinutesToFillPhoneRemainingStorage = phoneRemainingStorageMB / oneMinuteOfVideoMB;

let  userMessage = "You can record \(videoMinutesToFillPhoneRemainingStorage) more minutes of video"
