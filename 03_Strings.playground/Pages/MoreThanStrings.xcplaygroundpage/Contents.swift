...
let name = "Princess"
let dollars = 1000
let purchaseAdj = "front-row"
let purchase = "ticket to Hamilton"
let rogersAdj = "famous"
let place = "Richard Rogers Theatre"
let positiveEmotion = "excited"

let story = "Today was a big day for \(name). They had finally saved up \(dollars) dollars and were going to buy a \(purchaseAdj) to \(purchase). They went to the \(rogersAdj) \(place) feeling very \(positiveEmotion).";
//:
//:
